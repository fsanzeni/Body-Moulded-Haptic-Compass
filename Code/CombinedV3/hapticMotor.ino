// Use this function to play a single haptic waveform - the pattern repeats after the coolDown time (in milliseconds)
...
// Use this function to chain two haptic waveforms - the pattern repeats after the coolDown time (in milliseconds)
...
// Waveforms as described by the DRV2605 datasheet - use this function to loop through the waveforms to choose the preferred one
